...
jsPsych.plugins["visual-search-circle-inverted"] = (function() {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    function show_search_array() {
      ...
      for (var i = 0; i < display_locs.length; i++) {
        ...
        paper.innerHTML += "<img src='"+to_present[i]+"' style='position: absolute; top:"+display_locs[i][0]+"px; left:"+display_locs[i][1]+"px; width:"+trial.target_size[0]+"px; height:"+trial.target_size[1]+"px; transform:rotate(180deg);'></img>";
